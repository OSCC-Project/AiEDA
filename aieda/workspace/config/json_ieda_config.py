...
class ConfigIEDADbParser(JsonParser):
    ...
    def create_json_default(self, paths_table):
        ...
        if self.read_create():                   
            self.json_data = self.default_json
            self.json_data['OUTPUT']['output_dir_path'] = paths_table.ieda_output['result']
...
class ConfigIEDAFixFanoutParser(JsonParser):
    ...
    def create_json_default(self, paths_table):
        ...
        if self.read_create():                   
            ...
            self.json_data['file_path']['design_work_space'] = paths_table.ieda_output['no']
            self.json_data['file_path']['output_def'] = "{}/ino.def".format(paths_table.ieda_output['no'])
            self.json_data['file_path']['report_file'] = "{}/ino.rpt".format(paths_table.ieda_output['no'])
            self.json_data['file_path']['gds_file'] = "{}/ino.gds".format(paths_table.ieda_output['no'])
...
class ConfigIEDARouterParser(JsonParser):
    ...
    def create_json_default(self, paths_table):
        ...
        if self.read_create():                   
            ...
            self.json_data['RT']['-temp_directory_path'] = "{}".format(paths_table.ieda_output['rt'])
...
class ConfigIEDATimingOptParser(JsonParser):
    ...
    def default_json(self):
        dict_data = \
        {
            ...
            "specific_prefix": {
                "drv": {
                    "make_buffer": "drv_buffer_",
                    "make_net": "drv_net_"
                },
                "hold": {
                    "make_buffer": "hold_buffer_",
                    "make_net": "hold_net_"
                },
                "setup": {
                    "make_buffer": "setup_buffer_",
                    "make_net": "setup_net_"
                }
            },
            "routing_tree": "flute",
    ...
    def create_json_default(self, paths_table, opt_type : str):
        ...
        if self.read_create():                   
            ...
            self.json_data['file_path']['design_work_space'] = paths_table.ieda_output['to']
            self.json_data['file_path']['output_def'] = "{}/ito.def".format(paths_table.ieda_output['to'])
            self.json_data['file_path']['report_file'] = "{}/ito.rpt".format(paths_table.ieda_output['to'])
            self.json_data['file_path']['gds_file'] = "{}/ito.gds".format(paths_table.ieda_output['to'])
