...
class DataPatterns(DataVectors):
    ...
    def generate_wire_patterns(self, vector_nets : List[VectorNet]=[],
                               epsilon: int = 1,
        ...
        wire_patterns = VectorWirePatterns(patterns_csv=patterns_csv,
    ...
    def generate_wire_sequences(self, vector_nets : List[VectorNet]=[],
                               epsilon: int = 1,
        ...
        wire_sequences = VectorWireSequences(json_path=sequences_json, 
                                             logger=self.workspace.logger, 
                                             epsilon=epsilon)
