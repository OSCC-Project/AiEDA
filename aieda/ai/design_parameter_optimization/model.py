...
class NNIOptimization(AbstractOptimizationMethod):
        ...
        try:
            ...
            if trial_number:
                ...
                if current_trial >= max_trial_num :
                    ...
                    print(f"The best parameter has been synchronized to the default configuration file")
            else:
    ...
    def runOptimization(self, step=DbFlow.FlowStep.place, option=FeatureOption.tools, metrics={"hpwl": 1.0, "tns": 0.0, "wns": 0.0}, pre_step=DbFlow.FlowStep.cts, tool="iEDA"):
        ...
        self.config_manage = ConfigManagement(workspace=workspace, eda_tool=tool, step=self._step)
